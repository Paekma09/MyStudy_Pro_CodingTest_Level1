...
public class Main {
	...
	*/
	public static void main(String[] args) {
		...
		System.out.print(Arrays.toString(d1)+" "+budget1+" ");
		System.out.println(solution(d1, budget1));
		System.out.print(Arrays.toString(d2)+" "+budget2+" ");
		System.out.println(solution(d2, budget2));
	}
	
	public static int solution(int[] d, int budget) {
		// 문제의 조건에 의하면 가장 물품의 금액이 적은 부서부터 차례로 지원해야지만 최대한 많은 부서를 지원할 수 있다.
		int answer = 0;
		int sum = 0;
		int count = 0;
		// 오름차순으로 정렬
		Arrays.sort(d);
		// sum에 부서별 지원금액을 합하며 budget보다 커지면 반복문 종료 한다.
		// count가 지원하는 부서의 최대값이다.
