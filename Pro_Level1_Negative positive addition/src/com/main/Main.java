...
public class Main {
	...
	*/
	public static void main(String[] args) {
		...
		System.out.print(Arrays.toString(absolutes1)+" "+Arrays.toString(signs1)+" ");
		System.out.println(solution(absolutes1, signs1));
		System.out.print(Arrays.toString(absolutes2)+" "+Arrays.toString(signs2)+" ");
		System.out.println(solution(absolutes2, signs2));
	}
	
	public static int solution(int[] absolutes, boolean[] signs) {
        int answer = 0;
        // 반복문으로 sign배열의 값으로 분기하여 true이면 더하고 false이면 뺀다.
