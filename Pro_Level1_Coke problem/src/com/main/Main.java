...
public class Main {
	...
	public static int solution(int a, int b, int n) {
        ...
        /*
         * 문제 내용
         * n을 반복문으로 돌리는데 한 회차 돌 때 마다 아래와 같은 형태이다.
            n을 a로 나눈 몫과 b를 곱한 값이 받을 수 있는 병 수
            받은 병수와 n을 a로 나눈 나머지 병을 합한 것이 총 빈 병수
            n이 a보다 같거나 작을 대까지 반복
            받을 수 있는 병수 answer는 한 번 돌때마다 받은 병수의 총합
         */
        int temp = 0;
        while(n >= a) {
        	temp = ((n / a)) * b;
