...
public class Main {
	...
	public static String solution(int[] food) {
        String answer = "";
        // 문제는 food배열의 0번 인덱스 제외하고 1번 인덱스부터 반복하는데 해당 값을 2로 나눈 몫만큼 인데스 번호를 문자열에 추가하고 끝나면
        // 0과 만들어진 문자열의 리버스된 문자열을 합치면 되는 것이다.
        String pre = "";
        ...
        // pre 문자열을 뒤집기 위해 StringBuffer 이용.
        StringBuffer sb = new StringBuffer(pre);
        String suf = sb.reverse().toString();
        // pre문자열 + "0" + suf문자열
        answer = pre.concat("0").concat(suf); 
        return answer;
    }
}